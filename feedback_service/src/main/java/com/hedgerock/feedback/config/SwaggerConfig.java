...
public class SwaggerConfig {
    ...
    @SecurityScheme(name = "keycloak", type = SecuritySchemeType.OAUTH2, flows = @OAuthFlows(
            authorizationCode = @OAuthFlow(
                    authorizationUrl = "${keycloak.uri}/realms/application_keycloak/protocol/openid-connect/auth",
                    tokenUrl = "${keycloak.uri}/realms/application_keycloak/protocol/openid-connect/token",
                    scopes = {
