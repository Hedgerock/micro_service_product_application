...
public class ProductsListController extends BatyaController {
    ...
    public String createProduct(
        ...
        model.addAttribute("newProduct", Objects.requireNonNullElseGet(productPayload, () -> new Product(-1, null, null).getUpdatePayload()));
    ...
    public String initProduct(
        ...
        try {
            Product product = this.productRestClient.createProduct(newProductPayload);
